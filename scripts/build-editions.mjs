...
const communityBasePath = "/docs/synth/community";
...
// 1. Build Enterprise Edition — default env.
await clean(".next");
await clean(outDir);
...
// 3. Merge Community's nested output into the Enterprise tree.
...
console.log(
  `Built Enterprise (out/docs/synth) + Community (out${communityBasePath}) editions`,
);
